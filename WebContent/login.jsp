                                    ...
                                    <div class="card-body">
                                        <form method="post" action="LoginAdmin" >
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="inputEmailAddress" type="email" value=" ${after.NameAdmin} " placeholder="Enter email address" required/>
                                                <span  style="color: red;">${errors.failAdmin}</span>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">Password</label>
                                                <input class="form-control py-4" name="inputPassword" type="password" placeholder="Enter password" required />
                                                <span style="color: red;">${errors.failAminpass}</span>
                                            </div>
                                            <div class="form-group">
